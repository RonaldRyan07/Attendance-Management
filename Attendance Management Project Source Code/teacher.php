 ...
 <body>
   <!-- Fixed navbar -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<img src="cmr.png" alt="Welcome to CMRIT!" width="140" height="95" >
    <h2><a class="navbar-brand" href="index.php" style="font-size:28px;">CMR Institute of Technology</a></h2>
  ...
  <br><br><div class="container">
    <?php
      ...
      echo '<br><br><br><br><br><br><h2>Welcome , '.$name.'.</h2>';
  ...
  <div class="modal fade bs-example-modal-lg" tab-index="-1" role="dialog" aria-labeled="addClass" aria-hidden="true">
