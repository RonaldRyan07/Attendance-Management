    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
	     ...
	     <a class="navbar-brand" href="index.php" style="font-size:28px;"><br>CMR Institute of Technology</a><br />
    ...
    <script type="text/javascript">
        $(function () {
            $("#txtName").keypress(function (e) {
                ...
                if (!isValid) {
                    $("#lblError").html("Only alphabets are allowed.");
                }
...
<script type="text/javascript">
        $(function () {
            $("#num").keypress(function (e) {
                ...
                var isValid = regex.test(String.fromCharCode(keyCode));
                if (!isValid) {
                    $("#lblError").html("Only numbers are allowed");
                }
    ...
    <table class="table table-bordered table-striped">
          ...
          <td>
            <form id="signup">
              ...
              <div class="form-group">
                ...
                <span class="help-block">Password should be at least 6 characters long.</span>
              </div>
              <div class="form-group">
     ...
     <!-- FOOTER -->
      <footer style="background; height:140%;">
        ...
        <p>&copy; 2022 CMRIT, Inc. &middot;  developed by  <a href="https://localhost/Online%20Attendance%20Management%20System/index.php">KPR Technologies</a><a href="http://localhost/Online%20Attendance%20Management%20System/index.php"> &middot; Privacy</a> &middot; <a href="Online%20Attendance%20Management%20System/index.php">Terms</a></p>
      </footer>
