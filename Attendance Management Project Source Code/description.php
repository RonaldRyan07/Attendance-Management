...
<br><br><div style="font-family: montserrat;text-align:center; font-size:50px;"><i>Student Description</i></div><br><br>
...
<form method="post" action="description.php">
	<table class="table table-bordered table-striped">
		...
		<tr>
			...
			<td><input class="form-control" placeholder="Age as of today" type="text" name="age"></td>
		</tr>
		<tr>
		...
		<table style="position: absolute; width: 50%; left: 34%; ">
			<tr>
			<td><input style="background-color: green; color: white; border: 5px; padding: 20px; border-radius: 50%; " type="submit" name="submit-btn" value="Submit Form"></td><br>
			<td><input style="background-color: orange; color: white; border: 5px; padding: 20px; border-radius: 50%; " type="reset" name="reset-btn" value="Reset Form"></td>
		</tr>
		</table>
</form>
</body>
